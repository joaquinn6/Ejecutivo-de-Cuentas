  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <form action="crearTelefonoServlet" method="post">
        ...
        <input type="text" class="form-control" name="Numero" value='<c:out value="${telefono.numero}" ></c:out>'>

        <label for="Extension">Extension</label>
        <input type="text" class="form-control" name="Extension" value='<c:out value="${telefono.extension}"></c:out>'>
        <br>
        <div class="row">
